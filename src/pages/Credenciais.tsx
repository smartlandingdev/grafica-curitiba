...
const features = [
  { icon: "ri-id-card-line", label: "Papel e PVC" },
  { icon: "ri-printer-line", label: "Impressão Digital" },
  { icon: "ri-shield-user-line", label: "Identificação Segura" },
  { icon: "ri-calendar-event-line", label: "Ideal para Eventos" },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-[26px] sm:text-4xl lg:text-[48px] font-extrabold text-white leading-tight mb-4 sm:mb-6 drop-shadow-lg">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] via-[#D4AF37] to-[#AA771C]">Credenciais</span> em PVC
          </h1>
