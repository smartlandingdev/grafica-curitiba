      ...
      <section className="py-8 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[13px] text-white/40 leading-relaxed text-center">
            Gráfica Curitiba — envelopes personalizados com sua identidade visual. Impressão offset em papel resistente em tamanhos ofício, saco, carta e especiais. Curitiba e todo o Brasil.
          </p>
        </div>
      </section>
    </>
