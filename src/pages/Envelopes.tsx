...
const features = [
  { icon: "ri-mail-line", label: "Diversos Tamanhos" },
  { icon: "ri-printer-line", label: "Impressão Offset" },
  { icon: "ri-palette-line", label: "Full Color" },
  { icon: "ri-building-line", label: "Identidade Visual" },
];

const types = [
  {
    title: "Envelope Ofício",
    description: "Tamanho padrão para documentos e correspondências",
  },
  {
    title: "Envelope Saco",
    description: "Maior capacidade para documentos volumosos",
  },
  {
    title: "Envelope Carta",
    description: "Formato tradicional para correspondências",
  },
  {
    title: "Envelope com Janela",
    description: "Janela transparente para visualização do destinatário",
  },
];
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-[26px] sm:text-4xl lg:text-[48px] font-extrabold text-white leading-tight mb-4 sm:mb-6 drop-shadow-lg">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] via-[#D4AF37] to-[#AA771C]">Envelopes</span> Personalizados
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-20">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-bold text-white mb-4 sm:mb-6">
                Correspondências com Identidade Profissional
              </h2>
            ...
            <div
              ...
              style={{
                backgroundImage: `url("https://images.unsplash.com/photo-1579275542618-a1dfed5f54ba?w=800&h=600&fit=crop")`,
                backgroundSize: "cover",
                backgroundPosition: "center center",
              }}
            ></div>
