          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-20">
            <div>
              ...
              <p className="text-[14px] sm:text-[16px] text-[#555] leading-relaxed mb-4 sm:mb-6">
                O receituário é um dos itens mais importantes da identidade
                visual de médicos, dentistas e outros profissionais da saúde. Um
                receituário bem elaborado transmite profissionalismo e
                credibilidade aos pacientes.
              </p>
              <p className="text-[14px] sm:text-[16px] text-[#555] leading-relaxed mb-4 sm:mb-6">
                Produzimos receituários em diversos formatos, incluindo o padrão
                para receitas simples e os formatos específicos exigidos para
                medicamentos controlados. Papel de alta qualidade com impressão
                nítida.
              </p>
              <p className="text-[14px] sm:text-[16px] text-[#555] leading-relaxed">
                Personalizamos com nome do profissional, CRM/CRO, especialidade,
                endereço e telefone. Também oferecemos versões com cópia
                carbonada para controle do consultório.
              </p>
            </div>
            <div
      ...
      <section className="py-12 sm:py-20 bg-[#FFF4F0]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-sm sm:text-lg text-[#555] mb-6 sm:mb-10 max-w-2xl mx-auto px-2">
            Entre em contato e personalize seus receituários com qualidade
            profissional.
          </p>
          <CTAButton type="receituario" size="lg" />
