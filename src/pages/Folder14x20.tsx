...
const features = [
  ...
  { icon: "ri-layout-grid-line", label: "Formato 14x20 cm" },
    ...
    <>
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "@type": "Product",
          name: "Folder 14x20 cm",
          description:
            "Impressão de folders 14x20 cm personalizados em Curitiba. Alta qualidade, cores vibrantes e entrega rápida. Orçamento via WhatsApp (41) 3024-0080.",
          brand: {
            "@type": "Organization",
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-[26px] sm:text-4xl lg:text-[48px] font-extrabold text-white leading-tight mb-4 sm:mb-6 drop-shadow-lg">
            Folder <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] via-[#D4AF37] to-[#AA771C]">14x20 cm</span>
          </h1>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-20">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-bold text-white mb-4 sm:mb-6">
                Folder 14x20 cm Personalizado
              </h2>
              <p className="text-[14px] sm:text-[16px] text-white/70 leading-relaxed mb-4 sm:mb-6">
                O folder 14x20 cm é o formato intermediário mais popular. Com
                espaço suficiente para textos e imagens, é a escolha ideal para
                cardápios, catálogos compactos e material informativo.
              </p>
              <p className="text-[14px] sm:text-[16px] text-white/70 leading-relaxed mb-4 sm:mb-6">
                Esse formato oferece o equilíbrio perfeito entre praticidade e
                área de impressão, permitindo apresentar seu conteúdo de forma
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
              {formatOptions.map((option) => (
                ...
                >
                  ...
                  <a
                    href={`https://wa.me/+554130240080?text=${encodeURIComponent(`Gostaria de solicitar orçamento para Folder 14x20 em ${option.title}`)}`}
                    target="_blank"
