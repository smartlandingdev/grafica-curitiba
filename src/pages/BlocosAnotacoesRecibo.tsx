      ...
      <section className="py-8 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[13px] text-white/40 leading-relaxed text-center">
            Blocos de recibo e anotações personalizados pela Gráfica Curitiba, com numeração sequencial, vias carbonadas e impressão profissional. Atendemos empresas em Curitiba e todo o Brasil.
          </p>
        </div>
      </section>
    </>
