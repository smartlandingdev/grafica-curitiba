      ...
      <section className="py-8 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[13px] text-white/40 leading-relaxed text-center">
            Gráfica Curitiba — LixoCar personalizado com a marca da sua empresa. Brinde corporativo em TNT ou courvin com impressão full color. Curitiba e todo o Brasil.
          </p>
        </div>
      </section>
    </>
