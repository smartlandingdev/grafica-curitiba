          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-sm sm:text-lg text-white/80 leading-relaxed mb-6 sm:mb-10">
                ...
                divulgação. Material resistente e cores vibrantes que destacam
                sua marca.
              </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-6 max-w-4xl mx-auto">
            {productOptions.map((option) => (
              ...
              >
                ...
                <a
                  href={`https://wa.me/+554130240080?text=${encodeURIComponent(`Gostaria de solicitar orçamento para ${option.title}`)}`}
                  target="_blank"
      ...
      <section className="py-8 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[13px] text-white/40 leading-relaxed text-center">
            Banners profissionais impressos pela Gráfica Curitiba com alta resolução, material resistente e cores vibrantes. Atendemos Curitiba e todo o Brasil com entrega rápida para eventos, feiras e fachadas comerciais.
          </p>
        </div>
      </section>
    </>
