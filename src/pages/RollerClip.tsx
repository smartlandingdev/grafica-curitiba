          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              <h1 className="text-[26px] sm:text-4xl lg:text-[42px] font-extrabold text-white leading-tight mb-4 sm:mb-6">
                Roller <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] via-[#D4AF37] to-[#AA771C]">Clip</span>
              </h1>
            ...
            <div
              ...
              style={{
                backgroundImage: `url("${rollerClipImg}")`,
      ...
      <section className="py-8 bg-[#1A1A1A]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-[13px] text-white/40 leading-relaxed text-center">
            Gráfica Curitiba — Roller Clip personalizado, porta-crachá retrátil com impressão da sua logo. Ideal para empresas, hospitais e escolas. Curitiba e todo o Brasil.
          </p>
        </div>
      </section>
    </>
