          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-sm sm:text-lg text-white/80 leading-relaxed mb-6 sm:mb-10">
                Impressão de folders 20x28 cm personalizados. O maior formato, perfeito para apresentações detalhadas, catálogos e materiais institucionais.
              </p>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            {formatOptions.map((option) => (
              ...
              >
                ...
                <a
                  href={`https://wa.me/+554130240080?text=${encodeURIComponent(`Gostaria de solicitar orçamento para Folder 20x28 em ${option.title}`)}`}
                  target="_blank"
