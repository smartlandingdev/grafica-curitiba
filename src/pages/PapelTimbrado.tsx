...
const features = [
  ...
  { icon: "ri-shield-check-line", label: "Papel Premium" },
];

const benefits = [
  {
    title: "Credibilidade",
    description: "Documentos oficiais transmitem mais confiança",
  },
  {
    title: "Identidade Visual",
    description: "Sua marca presente em toda comunicação escrita",
  },
  {
    title: "Profissionalismo",
    description: "Apresentação diferenciada para propostas e contratos",
  },
  {
    title: "Padronização",
    description: "Comunicação visual consistente em toda empresa",
  },
];

function PapelTimbrado() {
  return (
    <>
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          name: "Papel Timbrado",
          description:
            "Papel timbrado personalizado em Curitiba. Impressão offset em papel de alta qualidade. Identidade visual profissional para documentos.",
      ...
      >
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-[26px] sm:text-4xl lg:text-[48px] font-extrabold text-white leading-tight mb-4 sm:mb-6 drop-shadow-lg">
            Papel <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#BF953F] via-[#FCF6BA] via-[#D4AF37] to-[#AA771C]">Timbrado</span>
          </h1>
          <p className="text-sm sm:text-lg lg:text-xl text-white/90 max-w-3xl mx-auto mb-6 sm:mb-10 leading-relaxed px-2">
            Papel timbrado com a identidade visual da sua empresa. Documentos
            profissionais que transmitem credibilidade e confiança.
          </p>
          <CTAButton type="papelTimbrado" size="lg" />
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center mb-12 sm:mb-20">
            <div>
              <h2 className="text-2xl sm:text-3xl lg:text-[38px] font-bold text-white mb-4 sm:mb-6">
                Documentos com Identidade Profissional
              </h2>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
              {benefits.map((benefit) => (
                ...
                >
                  ...
                  <a
                    href={`https://wa.me/+554130240080?text=${encodeURIComponent(`Gostaria de solicitar orçamento para Papel Timbrado`)}`}
                    target="_blank"
      ...
      <section className="py-12 sm:py-20 bg-gradient-to-b from-[#1A1A1A] to-[#252525]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-xl sm:text-2xl lg:text-[38px] font-bold text-white mb-4 sm:mb-6">
            Solicite Seu Orçamento de Papel Timbrado
          </h2>
          <p className="text-sm sm:text-lg text-white/70 mb-6 sm:mb-10 max-w-2xl mx-auto px-2">
            Entre em contato e profissionalize os documentos da sua empresa com
            papel timbrado de qualidade.
          </p>
          <CTAButton type="papelTimbrado" size="lg" />
