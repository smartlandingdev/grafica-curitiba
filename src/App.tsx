    ...
    <footer id="contato" className="bg-[#2C2C2C] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          {/* Column 3 - Location */}
          <div>
            <h3 className="text-[14px] sm:text-[16px] font-bold mb-3 sm:mb-4">Endereço</h3>
            <div className="space-y-2 sm:space-y-3 text-[13px] sm:text-[15px] text-[#D0D0D0]">
              <div className="flex items-start gap-2 sm:gap-3">
                ...
                <span>
                  Gráfica Curitiba Limitada<br />
                  Av. Alcir Martins Bastos, 62<br />
                  Fazendinha - Curitiba - PR<br />
                  CEP 81.330-400
                </span>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
                <i className="ri-truck-line text-base sm:text-lg mt-0.5 flex-shrink-0"></i>
                <span className="text-[#25D366] font-medium">Atendemos todo o Brasil</span>
              </div>
              <div className="flex items-start gap-2 sm:gap-3">
          ...
          <div>
            <h3 className="text-[14px] sm:text-[16px] font-bold mb-3 sm:mb-4">Redes Sociais</h3>
            <div className="space-y-2 sm:space-y-3">
              <a href="https://www.instagram.com/graficacuritibaonline/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 text-[13px] sm:text-[15px] text-[#D0D0D0] hover:text-[#E4405F] transition-colors cursor-pointer">
                <i className="ri-instagram-line text-base sm:text-lg"></i>
                <span>@graficacuritibaonline</span>
              </a>
              <a href="https://www.youtube.com/@graficacuritibaonline" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 text-[13px] sm:text-[15px] text-[#D0D0D0] hover:text-[#FF0000] transition-colors cursor-pointer">
                <i className="ri-youtube-line text-base sm:text-lg"></i>
                <span>@graficacuritibaonline</span>
              </a>
              <a href="https://www.facebook.com/GraficaCuritiba2" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 sm:gap-3 text-[13px] sm:text-[15px] text-[#D0D0D0] hover:text-[#1877F2] transition-colors cursor-pointer">
